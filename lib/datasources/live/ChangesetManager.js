...
ChangesetManager.prototype.checkForChangesets = function() {
    ...
    /* Once we have downloaded, and parsed the changesets, we generate an operation list, and
     apply it on the database.
     */
...
ChangesetManager.prototype.postApplyCleanup = function() {
    ...
    if(this._opList.csListsIdx >= this._changesetLists.length) {
        ...
        console.log("Removing up to the "+this._opList.csListsIdx+"th csList, and "+
                    this._opList.cSetPos+"th cset");
