...
function ChangesetManager(options,applyCsetCallback) {
  ...
  this._HOUR_STEP = options.hourStep || 25; // Maximum number of hours to check per cycle
  this._CSET_THRESHOLD = options.changesetThreshold || 500; // Maximum number of changesets to apply per cycle
