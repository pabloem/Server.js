...
ChangesetManager.prototype.checkForChangesets = function() {
     ...
     */
    this._afterChangesetDownload = this.applyChangesets;
    /* After applying a set of changes, we cleanup after ourselves.
     */
    this._afterApply = this.postApplyCleanup;
    this._afterCleanup = function(){};
...
ChangesetManager._applyOperationList = function() {
    /* TODO - Implement */
};
