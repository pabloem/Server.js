...
function PollingAgent(options) {
    ...
    var csmFile = (options.changesetManager || './ChangesetManager.js');
    if (!fs.existsSync(csmFile))
        throw Error('Not a valid file: ' + csmFile);

    var ChangesetManager = require(csmFile);
